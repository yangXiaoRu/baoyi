...
import com.xiyou.baoyi.xinwa.view.MyViewPager;
import com.xiyou.baoyi.xinwa.view.ZoomImageView;
...
public class DetailImageAty extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager = (MyViewPager) findViewById(R.id.image_viewpager);
	...
	private void initData() {
		...
		ZoomImageView view1 = (ZoomImageView) lf.inflate(R.layout.zoom_imageview, null);  
		ZoomImageView view2 = (ZoomImageView) lf.inflate(R.layout.zoom_imageview, null);  
		ZoomImageView view3 = (ZoomImageView) lf.inflate(R.layout.zoom_imageview, null);  
