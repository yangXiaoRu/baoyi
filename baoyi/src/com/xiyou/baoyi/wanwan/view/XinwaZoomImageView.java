...
public class XinwaZoomImageView extends View {
	 ...
	 * @param attrs
	 */
	public XinwaZoomImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setViewPager(DetailViewPager viewPager){
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			if (event.getPointerCount() == 1) {
				System.out.println("initRatio ="+initRatio+",totalRatio="+totalRatio);
	...
	protected void onDraw(Canvas canvas) {
		...
		case STATUS_INIT:
			initBitmap(canvas);
		default://这条语句只有在以上条件都不满足的情况下才会执行
	...
	public int getTotalScale(){
		return (int)totalRatio;
	}
	
	public int getInitScale(){
		return (int)initRatio;
	}
